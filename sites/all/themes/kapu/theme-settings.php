 ...
 */
function kapu_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['kapu_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('kapu sample setting'),
  '#default_value' => theme_get_setting('kapu_example'),
